...
export default function Home({ searchParams }: HomeProps) {
  ...
  return (
    <section className="container flex flex-col items-center justify-center min-h-screen p-3 mx-auto gap-3">
      <div
        ref={ref}
      ...
      >
        <div className="top space-y-3">
          <h2 className="max-w-[15rem] mx-auto text-5xl">Username Secured!</h2>
          <div
            className={`w-full max-w-[15rem] p-3 mx-auto text-2xl  text-[#2063F2] bg-white rounded-lg box-shadow-custom border border-black light-font font-light`}
          >
            {name ?? "username"}.mtpx
          </div>
        </div>
